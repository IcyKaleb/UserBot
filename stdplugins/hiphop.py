...
@borg.on(admin_cmd(pattern="hiphop ?(.*)", allow_sudo=True))
async def main(event):
    await event.edit("Automatic Profile Pictures has been started \n\nPictures type :- Hip Hop\n\n@KarvorTM") #Owner @NihiNivi
    while True:
        await animepp()
